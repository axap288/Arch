...
- (void)setUpAudioSession
{
	...
	(
     ...
     interruptionListener,	// A reference to your interruption listener callback function.
                          ...
                          UInt32	inInterruptionState)
{
	...
	{
        NSLog(@"===后台播放被打断，播放暂停");
        [[NSNotificationCenter defaultCenter] postNotificationName:@"playbackBeginInterruption" object:nil];
    }
	else if (inInterruptionState == kAudioSessionEndInterruption)
	{
        NSLog(@"===后台播放继续");
        [[NSNotificationCenter defaultCenter] postNotificationName:@"playbackEndInterruption" object:nil];
	}
}
