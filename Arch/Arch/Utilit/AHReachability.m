...
//		[[YBModalAlert sharedInstance] showAlertToUser:NSLocalizedString(@"Error_Title", @"") message:@"Error addressFromString" button:NSLocalizedString(@"Button_Title_Confirm", @"") isTimer:YES];
        return NO;
    }
...
{
	if (![watcher conformsToProtocol:@protocol(IRReachabilityWatcher)])
	{
